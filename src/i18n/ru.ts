export const ru = {
  ...
  diagnosticsToast: {
    ...
    savedDesc: "Ваши результаты диагностики сохранены",
    errorTitle: "Ошибка",
    errorDesc: "Произошла ошибка при сохранении результатов",
  },

  // Cases List extras
  casesListExtra: {
    simulator: "Командный симулятор",
    subtitle: "Распределяйте роли, проходите этапы, решайте конфликты и оценивайте работу команды",
    stepSim: "Пошаговая симуляция",
    conflictScenarios: "Конфликтные сценарии",
    feedback360: "обратная связь",
    phases: "этапов",
  ...
  // Profile errors
  profileErrors: {
    loadTestsError: "Произошла ошибка при загрузке тестов",
  },
  ...
  trainers: {
    title: "Тренажёры",
    titleHighlight: "навыков",
    subtitle: "Практические упражнения для развития soft skills через реальные сценарии",
    scenarios: "сценариев",
    start: "Начать",
    restart: "Заново",
    completed: "Тренажёр пройден!",
    avgScore: "Средний балл",
    points: "баллов",
    criteriaMatched: "критериев выполнено",
    nextScenario: "Следующий сценарий",
    finishTrainer: "Завершить",
    continue: "Продолжить",
    checkAnswer: "Проверить",
    modelAnswer: "Эталонный ответ",
    chooseTopic: "Выберите тему для выступления",
    fillOutline: "Заполните план вашего выступления",
    toChecklist: "К самооценке",
    selfAssess: "Оцените своё выступление по следующим критериям",
    sbiTitle: "Конструктивная обратная связь (SBI)",
    sbiDesc: "Научитесь давать обратную связь по модели Situation-Behavior-Impact через реальные рабочие ситуации",
    sbiSPlaceholder: "Опишите ситуацию (когда, где, при каких обстоятельствах)",
    sbiBPlaceholder: "Опишите конкретное поведение (что человек сделал/сказал)",
    sbiIPlaceholder: "Опишите последствия (как это повлияло на вас/команду/результат)",
    conflictTitle: "Разрешение конфликтов",
    conflictDesc: "Пройдите через сценарии командных конфликтов и научитесь находить конструктивные решения",
    speakingTitle: "Публичное выступление",
    speakingDesc: "Подготовьте структурированное выступление на выбранную тему и оцените его по критериям",
    noAttempts: "Вы ещё не проходили тренажёры",
    ...
    details: "Подробности",
    back: "Назад",
    improveTips: "Рекомендации",
    // SBI — per-field tips shown when that field score is weak
    sbiSituationWeak: "Ситуация: указывайте конкретное время, место и контекст — «на совещании в понедельник», а не «как-то раз»",
    sbiBehaviorWeak: "Поведение: описывайте наблюдаемые действия — «ты опоздал на 15 минут», а не «ты безответственный»",
    sbiImpactWeak: "Последствия: объясняйте конкретное влияние — «команда не успела обсудить задачи», а не «это плохо»",
    sbiSituationGood: "Ситуация: вы хорошо описываете контекст — продолжайте в том же духе",
    sbiBehaviorGood: "Поведение: вы точно описываете действия — это ключевой навык SBI",
    sbiImpactGood: "Последствия: вы чётко объясняете влияние — отличная работа",
    // Conflict — per-score tips
    conflictLow: "Попробуйте выбирать варианты, которые вовлекают обе стороны в решение, а не игнорируют или давят",
    conflictMid: "Вы находите неплохие решения, но попробуйте искать варианты с долгосрочным эффектом, а не быстрые компромиссы",
    conflictHigh: "Отличные навыки медиации! Попробуйте усложнить — как бы вы действовали в конфликте с руководством?",
    // Speaking — per-rubric tips
    speakingMissing: "Обратите внимание на: {items}",
    speakingAllGood: "Вы отметили все критерии — попробуйте записать выступление на видео и пересмотреть",
  },
  ...
  group: {
    ...
    vsAverage: "Вы vs группа",
    sortBy: "Сортировать",
    noGroup: "Вы не состоите в группе. Укажите группу в настройках профиля.",
    members: "участников",
    you: "Вы",
  },
  ...
  diagnosticsPage: {
    ...
    confirmDesc: "Вы ответили на {answered} из {total} вопросов. После завершения изменить ответы будет невозможно.",
    confirmCancel: "Вернуться",
    confirmSubmit: "Завершить тест",
    unanswered: "Не отвечено: {count}",
  },
  ...
  results: {
    ...
    profilePatterns: {
      ...
      mechanics_expert: "Эксперт по механике",
      thermo_specialist: "Специалист по термодинамике",
      em_specialist: "Специалист по электромагнетизму",
      optics_specialist: "Специалист по оптике",
      balanced_physicist: "Сбалансированный физик",
      emerging_physicist: "Начинающий физик",
      specialist_physics: "Узкий специалист (физика)",
      info_seeker: "Искатель информации",
      communicator: "Коммуникатор",
      reflective_learner: "Рефлексивный ученик",
      digital_native: "Цифровой энтузиаст",
      balanced_competent: "Сбалансированная компетентность",
      emerging_learner: "Начинающий ученик",
      specialist_info: "Узкий специалист (ИКТ)",
    },
    skillLevels: {
      beginner: "Начинающий",
      basic: "Базовый",
  ...
  selfAssessment: {
    title: "Самооценка",
    subtitle: "Оцените свою работу в команде",
    gapLabel: "Разрыв",
    selfLabel: "Вы",
    peersLabel: "Команда",
    overestimate: "Переоценка",
    underestimate: "Недооценка",
    accurate: "Точная оценка",
  },
  profileCases: {
    tab: "Кейсы",
    totalCases: "Кейсов пройдено",
    avgFeedback: "Средняя оценка 360°",
    commonRole: "Частая роль",
    noCases: "Кейсы ещё не пройдены",
    role: "Роль",
    peerScore: "Оценка команды",
    selfScore: "Самооценка",
    solutionScore: "Балл за решение",
    date: "Дата",
    gap: "Разрыв",
  },
  profileDashboard: {
    ...
    skillRadar: "Профиль навыков",
    groupRank: "Рейтинг в группе",
    topPercent: "Топ",
    ofGroup: "группы",
    students: "студентов",
    ...
    testsCount: "Тестов",
    casesCount: "Кейсов",
    trainersCount: "Тренажёров",
    avgScore: "Средний балл",
    feedbackAvg: "Оценка 360°",
  ...
  teacherProfile: {
    ...
    scoreSolutions: "Оценить решения",
    ...
    noActivity: "Нет активности в группе",
  ...
  dashboardCases: {
    ...
    casesCompleted: "Кейсов пройдено",
    avgPeerFeedback: "Средняя оценка 360°",
    avgSolutionScore: "Средний балл решений",
    avgCasesPerStudent: "Кейсов на студента",
    pendingGrading: "Ожидают оценки",
    scoreSolution: "Оценить решение",
    scoreLabel: "Балл (0-100)",
    scoreSaved: "Оценка сохранена",
    noCasesData: "Нет данных по кейсам",
    ungraded: "Не оценено",
  },
  ...
  physicsQuestions: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Нет — звуку нужна среда для распространения, а в космосе вакуум", score: 1 },
